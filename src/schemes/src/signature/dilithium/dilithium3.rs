...
use pqcrypto_dilithium::dilithium3 as dilithiumctx;
...
impl GenericSignaturePublicKey for PublicKey {    
    fn serialize(self, owner_name: &str) -> Result<SignaturePublicKey, Error> {
        ...
        Ok(SignaturePublicKey::new(Dilithium3::SCHEME_CODE, fingerprint.into(), bytes, None))
    }
...
impl GenericSignaturePrivateKey for PrivateKey {
    fn serialize(
        ...
        Ok(SignaturePrivateKey::new(Dilithium3::SCHEME_CODE, fingerprint, encryption, bytes))
    }
...
impl SignatureScheme for Dilithium3 {
    ...
    const NAME: &'static str = "DILITHIUM-3";
