...
use pqcrypto_mldsa::mldsa65 as mldsactx;
...
impl GenericSignaturePublicKey for PublicKey {
    fn serialize(self, owner_name: &str) -> Result<SignaturePublicKey, Error> {
        ...
        Ok(SignaturePublicKey::new(MlDsa65::SCHEME_CODE, fingerprint.into(), bytes, None))
    }
...
impl GenericSignaturePrivateKey for PrivateKey {
    fn serialize(
        ...
        Ok(SignaturePrivateKey::new(MlDsa65::SCHEME_CODE, fingerprint, encryption, bytes))
    }
