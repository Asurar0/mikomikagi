...
use dilithium::{MlDsa44, MlDsa65, MlDsa87};
...
use sphincs::{SlhDsaSha2128s, SlhDsaSha2256s};
...
pub static SIGNATURE_SCHEMES_LIST: [(u32,&str); 5] = [
    ...
    (SlhDsaSha2256s::SCHEME_CODE,   SlhDsaSha2256s::NAME),
    (MlDsa44::SCHEME_CODE,          MlDsa44::NAME),
    (MlDsa65::SCHEME_CODE,          MlDsa65::NAME),
    (MlDsa87::SCHEME_CODE,          MlDsa87::NAME)
];
